	...
	return (
		<header className='header'>
			<Link href='/' className='flex items-center gap-2 md:py-2'>
				<Image src="/assets/images/logo-text.svg" alt="logo" width={130} height={28} />
			</Link>
			...
			<nav className='flex gap-2'>
				<SignedIn>
					...
					<Sheet>
						<SheetTrigger>
							<Image src="/assets/icons/menu.svg" alt="menu" width={32} height={21} className='cursor-pointer' />
						</SheetTrigger>
